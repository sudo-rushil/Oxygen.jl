...
@testset "SmilesToMol" begin
    ...
    @test ethyl_acetate_mol.atoms == [OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("O"), OxygenAtom("O"), OxygenAtom("C"), OxygenAtom("C")]
    ...
    @test benzene_mol.atoms == [OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("C")]
    ...
    @test cipro_mol.atoms[7:11] == [OxygenAtom("C"), OxygenAtom("O"), OxygenAtom("C"), OxygenAtom("C"), OxygenAtom("C")]
